...
const config = {
    ...
    OTP_EXPIRY: 300000,
    NEWS_JSON_URL: 'https://chat.whatsapp.com/IXEMakbwk4xDcNPsVtKZ2n',
    BOT_NAME: ' chatuwa-xmd Mini Bot',
    OWNER_NAME: 'cyber chatuwa',
    OWNER_NUMBER: '94741336839',
    BOT_VERSION: '1.0.0',
    BOT_FOOTER: '> chatuwa ʙʏ chatuwa-xmd ᴅᴇᴠ.',
...
async function updateAboutStatus(socket) {
    const aboutStatus = 'CHATUWA XMD мιηι вσт ιѕ α¢тινє ησω🌸🧚‍♀️';
    try {
...
async function SendSlide(socket, jid, newsItems) {
    ...
    for (let item of newsItems) {
        ...
        try {
            ...
            imgBuffer = await Jimp.read('https://files.catbox.moe/1cac42.jpeg');
...
//================================ ALIVE ==================================
     ...
     const content = `𝐈𝐦 𝐂𝐲𝐛𝐞𝐫 𝐍𝐞𝐭 𝐌𝐢𝐧𝐢 𝐁𝐎𝐓 𝐌𝐚𝐝𝐞 𝐁𝐲 𝐂𝐲𝐛𝐞𝐫 𝐝𝐞𝐯𝐬.\n\n` +
                    ...
                    `🌐  CHATUWA-xmd MINI BOT  is a lightweight yet powerful WhatsApp user bot ⚡ built to handle downloads, searches, utilities, and fun commands — all in one place. Designed for speed 🚀, stability 🛡️, and style 🎭, it’s your personal cyber assistant on WhatsApp.\n` +
                    `⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌⛌\n` +
                    `𝑩𝑶𝑻 𝑾𝑬𝑩: තව නැතෝ\n` +
                    `▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n` +
                    `𝑪𝑯𝑨𝑵𝑬𝑳: තව නැ\n` +
...
//============================== OWNER ===============================
            ...
            + 'FN:SHALA OWNER\n'
            + 'ORG:SHALA OWNER\n'
            + 'TEL;type=CELL;type=VOICE;waid=94765342804 : 94741336839\n'
            + 'EMAIL:CHATUWA-xmd@gmail.com\n'
            + 'END:VCARD';

        await socket.sendMessage(sender, {
                            contacts: {
                                displayName: "CHATUWA-xmd Mini Bot Ofc. Owner",
                                contacts: [{ vcard }]
                            }
                        });     
                break;     
...
case 'song': {
    try {
        ...
        const titleText = '*✘ CHATUWA-xmd Songs*';
        const content = `┏━━━━━━━━━━━━━━━━\n` +
            `┃📝 \`Title\` : ${video.title}\n` +
            `┃📈 \`Views\` : ${video.views}\n` +
                ...
                try {
                    ...
                    await socket.sendMessage(userJid, {
                        ...
                        caption: formatMessage(
                            ...
                            '> ᴀʟʟ ʀɪɢʜᴛ ʀᴇꜱᴇʀᴠᴇᴅ ᴛᴏ CHATUWA-xmd'
                        )
                    });
                    ...
                    exec(`pm2 restart ${process.env.PM2_NAME || 'CHATUWA-xmd-Free-Bot-Session'}`);
                }
            }
        });
    } catch (error) {
